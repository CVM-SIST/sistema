...
<div id="nav-wrapper">
    <ul id="nav"
        ...
        <li>
            <a href="<?=$_GET['baseurl']?>comisiones/liquidaciones"><i class="fa fa-table"><span class="icon-bg bg-warning"></span></i><span data-i18n="Liquidaciones"></span></a>
            <ul <? is_active($_GET['section'],'liquidaciones') ?>>
                <li><a href="<?=$_GET['baseurl']?>liquidacion_mes"><i class="fa fa-caret-right"></i><span data-i18n="Genera Liquidacion"></span></a></li>
                <li><a href="<?=$_GET['baseurl']?>liquidaciones_ant"><i class="fa fa-caret-right"></i><span data-i18n="Liquidaciones Anteriores"></span></a></li>
            </ul>
        </li>
    </ul>
</div>
